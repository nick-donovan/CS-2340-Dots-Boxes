...
#
# Inputs: 
#   $a0 - the string to convert to indicies
# Outputs:
#   $v0 - the col index of the selected edge
#   $v1 - the row index of the selected edge
...
input_convert_edge_string:
  	...
  	move $s0, $a0
        ...
        move $a0, $s1
        jal input_validate_input_length
        ...
        move $a0, $s0
        move $a1, $s1
        jal input_validate_input_range
...
input_validate_input_range:
	...
	jal board_is_edge_claimed #TAKESE AO AND A1
	li $t0, 0x04
	andi $t1, $v0, 0x01###########
